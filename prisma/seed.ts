...
async function seed() {
  ...
  // Seed news
  await Promise.all([
    db.newsArticle.create({ data: { title: '«Трактор» сохранил молодых игроков: клуб сделал квалификационные предложения', slug: 'tractor-retains-young-players', excerpt: 'Хоккейный клуб «Трактор» объявил о сохранении ключевых молодых игроков команды на следующий сезон.', content: '## Сохранение костяка\n\nХоккейный клуб «Трактор» объявил о сохранении ключевых молодых игроков.', category: 'Хоккей', readTime: 3 } }),
    db.newsArticle.create({ data: { title: 'УЕФА изменит систему отбора на чемпионаты мира и Европы после Евро-2028', slug: 'uefa-qualification-changes-2028', excerpt: 'УЕФА анонсировал масштабные изменения в системе отбора на крупнейшие турниры.', content: '## Масштабные изменения\n\nУЕФА анонсировал масштабные изменения в системе отбора.', category: 'Футбол', readTime: 5 } }),
    db.newsArticle.create({ data: { title: 'Team Spirit одержала победу в DreamLeague S29', slug: 'team-spirit-dreamleague-s29', excerpt: 'Российская киберспортивная организация Team Spirit стала победителем DreamLeague Season 29.', content: '## Победа в DreamLeague\n\nTeam Spirit обыграла Tundra Esports со счётом 3:1.', category: 'Киберспорт', readTime: 3 } }),
    db.newsArticle.create({ data: { title: 'Медведев вышел в полуфинал Roland Garros', slug: 'medvedev-roland-garros-semifinal', excerpt: 'Даниил Медведев обыграл Стефаноса Циципаса в четырёх сетах и вышел в полуфинал.', content: '## Полуфинал Roland Garros\n\nМедведев одолел Циципаса в четырёх сетах.', category: 'Теннис', readTime: 4 } }),
    db.newsArticle.create({ data: { title: 'Аналитический обзор: тренды ставок на РПЛ в сезоне 2025/26', slug: 'rpl-betting-trends-2025-26', excerpt: 'Подробный анализ трендов ставок на Российскую Премьер-Лигу и прибыльные рынки.', content: '## Тренды ставок на РПЛ\n\nПодробный анализ прибыльных рынков и статистики.', category: 'Аналитика', readTime: 8 } }),
    db.newsArticle.create({ data: { title: 'Рафф остаётся в «Баффало»: контракт продлён до 2028', slug: 'ruff-buffalo-extension-2028', excerpt: '«Баффало Сэйбрз» продлили контракт с главным тренером Линди Раффом до 2028 года.', content: '## Продление контракта\n\nЛинди Рафф останется в «Баффало» до 2028 года.', category: 'Хоккей', readTime: 4 } }),
  ]);
