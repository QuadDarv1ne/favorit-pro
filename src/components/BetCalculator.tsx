  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-xl font-bold text-foreground">Калькулятор ставок</h2>
      </div>
          ...
          <Card className="bg-muted/50 border-border">
            <CardContent className="p-6">
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <label className="text-xs text-muted-foreground mb-1.5 block">Коэффициент</label>
                  <Input
                    type="number"
                    step="0.01"
                    min="1.01"
                    ...
                    className="bg-card border-border text-foreground text-lg font-semibold"
                  />
                </div>
                <div>
                  <label className="text-xs text-muted-foreground mb-1.5 block">Сумма ставки (₽)</label>
                  <Input
                    type="number"
                    min="10"
                    value={stake}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-card/50 rounded-xl p-4 text-center">
                  ...
                  <p className="text-xs text-muted-foreground mb-1">Выплата</p>
            ...
            <CardContent className="p-6">
              <div className="space-y-3 mb-6">
                {expressLegs.map((leg, i) => (
                  <div key={i} className="flex items-center gap-3 bg-card/50 rounded-lg px-3 py-2.5">
                    <Badge variant="secondary" className="bg-emerald-500/20 text-emerald-400 text-xs shrink-0">
                      {leg.odds}
                    </Badge>
                    <span className="text-sm text-muted-foreground flex-1 truncate">{leg.label}</span>
                    <button
                ...
                <Button
                  ...
                  className="w-full border-dashed border-border text-muted-foreground hover:text-emerald-400 hover:border-emerald-500/50"
                >
                  + Добавить событие
                </Button>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="bg-card/50 rounded-xl p-4 text-center">
                  <p className="text-xs text-muted-foreground mb-1">Общий коэфф.</p>
          ...
          <Card className="bg-muted/50 border-border">
            <CardContent className="p-6">
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="text-xs text-muted-foreground mb-1.5 block">Размер системы</label>
                  <Input
                    type="number"
                    min="2"
                    max="10"
                ...
                <div>
                  <label className="text-xs text-muted-foreground mb-1.5 block">Кол-во событий</label>
                  <Input
                    type="number"
                    min="3"
                    max="15"
