  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-xl font-bold text-foreground">Результаты</h2>
      </div>
      ...
      <div className="space-y-3">
        {finishedMatches.map((match, index) => (
          ...
          >
            <Card
              className="bg-muted/50 border-border hover:border-border transition-all cursor-pointer"
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6">
                  ...
                  {match.prediction && (
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <div>
                        <span className="text-xs text-muted-foreground block">Прогноз</span>
